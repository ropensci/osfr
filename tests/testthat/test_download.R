...
test_that("copying is not theft", {
  ...
  # expect_that(
  #   as.character(download(id = "bzm73", file = "test.file.remove", test = TRUE)$status_code),
  #   matches("200"))
  # expect_that(
  #   as.character(download(id = "bzm73", test = TRUE)$status_code),
  #   matches("200"))
  # expect_that(
  #   as.character(download(id = "2pf6w", file = "test.file.remove", test = TRUE,
