...
The GUID for this new project is `r my_project$id`, so you could check it out on OSF by opening its URL (`r paste0("https://www.osf.io/", my_project$id)`) in your browser, or, more conveniently: `osf_open(my_project)`.
...
## A more details about files on OSF
