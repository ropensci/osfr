...
#>   name                                             id    meta            
#>   <chr>                                            <chr> <list>          
#> 1 Political Identification and Gender: Re-examined zrvnt <named list [3]>
```

The GUID for this new project is zrvnt, but yours will be something different. You can check out the project on OSF by opening it's URL (`https://www.osf.io/<GUID>`), or, more conveniently: `osf_open(my_project)`.
...
#>   name         id                       meta            
#>   <chr>        <chr>                    <list>          
#> 1 raw_data.csv 5e3c2798032a4d00dee6e6f8 <named list [3]>
```
...
#>   name         id                       meta            
#>   <chr>        <chr>                    <list>          
#> 1 analyses.R   5e3c279df1369e01058ab088 <named list [3]>
#> 2 cleaning.R   5e3c27a0f1369e01058ab098 <named list [3]>
#> 3 precompile.R 5e3c27a3032a4d00dce6eece <named list [3]>
```
...
#>   name                 id                       meta            
#>   <chr>                <chr>                    <list>          
#> 1 Data Dictionary.docx 5e3c27a8f1369e01058ab0ad <named list [3]>
#> 2 Questionnaire.docx   5e3c27aaf1369e01018ac3a9 <named list [3]>
```
...
#>   name               id    meta            
#>   <chr>              <chr> <list>          
#> 1 Research Materials 4j6ta <named list [3]>
#> 2 Analysis Scripts   evgkz <named list [3]>
#> 3 Raw Data           sd6gt <named list [3]>
```
