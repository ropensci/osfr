...
#>   name                                             id    meta            
#>   <chr>                                            <chr> <list>          
#> 1 Political Identification and Gender: Re-examined 27z6d <named list [3]>
```

The GUID for this new project is `27z6d`, but yours will be something different. You can check out the project on OSF by opening it's URL (`https://www.osf.io/<GUID>`), or, more conveniently: `osf_open(my_project)`.
...
#>   name         id                       meta            
#>   <chr>        <chr>                    <list>          
#> 1 raw_data.csv 63306e9c6c2401124550961c <named list [3]>
```
...
#>   name         id                       meta            
#>   <chr>        <chr>                    <list>          
#> 1 analyses.R   63306ea20b727211612af6f2 <named list [3]>
#> 2 cleaning.R   63306ea46c2401125650a29c <named list [3]>
#> 3 precompile.R 63306ea6408a271241763b13 <named list [3]>
```
...
#>   name                 id                       meta            
#>   <chr>                <chr>                    <list>          
#> 1 Data Dictionary.docx 63306ead0b727211542b0446 <named list [3]>
#> 2 Questionnaire.docx   63306eaf0b727211542b044c <named list [3]>
```
...
#>   name               id    meta            
#>   <chr>              <chr> <list>          
#> 1 Research Materials sjdcz <named list [3]>
#> 2 Analysis Scripts   t3xup <named list [3]>
#> 3 Raw Data           ef58g <named list [3]>
```
