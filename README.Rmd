...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/aaronwolen/osfr?branch=master&svg=true)](https://ci.appveyor.com/project/aaronwolen/osfr)
...
The original version of osfr was developed by [@chartgerink][chris] and further developed by [@bgrich][brian] and [@hafen][ryan]. The current version was developed by [@aaronwolen][aaron] and is *heavily* inspired by [@jennybc][jenny] and [@lucymcgowan][lucy]'s excellent [googledrive][] package. Seriously, we borrowed a lot of great ideas from them. Other important resources include [http testing](https://ropensci.github.io/http-testing-book/) by Scott Chamberlain and [R Packages](http://r-pkgs.had.co.nz) by Hadley Wickham. Development was also greatly facilitated by OSF's excellent [API documentation][osf-api]. 
